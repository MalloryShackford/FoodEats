...
const Navbar = () => {
  ...
  return (
    <div className="max-w-[1640px] mx-auto flex justify-between items-center p-4">
        ...
        <h1 className="text-2xl sm:text-3xl lgLtext-4xl px-2">Best <span className="font-bold">Eats</span></h1>
    ...
    {/* Cart Button */}
    <div>
        <button className="bg-black text-white flex md:flex items-center py-2 rounded-full"><BsFillCartFill size={20} className="mr-2"/>Cart</button>
    {/* Mobile Menu */}
        {/* Overlay */}
